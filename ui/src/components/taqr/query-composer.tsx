  ...
  return (
    <div className="border-t bg-background/95 px-4 py-3 backdrop-blur md:px-8 md:py-4">
      <form
        ...
        className="mx-auto flex max-w-4xl items-end gap-2 border bg-background p-2 focus-within:ring-2 focus-within:ring-ring/30"
      >
        <Textarea
          ...
          className="max-h-36 min-h-10 flex-1 resize-none border-0 bg-transparent px-2 py-2 shadow-none focus-visible:ring-0"
          rows={1}
        />
      ...
      <p className="mx-auto mt-2 max-w-4xl text-center text-[0.625rem] text-muted-foreground">
